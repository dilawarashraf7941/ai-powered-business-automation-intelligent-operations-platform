...
CREATE TABLE IF NOT EXISTS security_audit_events (
    ...
    event_type TEXT NOT NULL CHECK(event_type IN (
        ...
        'EXECUTION_RECONCILIATION_AUTHORIZED',
        'EXECUTION_RECONCILIATION_REJECTED_BY_AUTHZ'
    )),
...
class SecurityAuditRepository:
    """Append security decisions to one process database chain without credential data."""
        ...
        *,
        ...
        try:
            ...
            connection.execute(
                ...
                SET event_count = ?, head_hash = ? WHERE singleton = 1""",
                (sequence, event_hash),
            )
            connection.commit()
        finally:
